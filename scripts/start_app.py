...
rough_handler1 = figure(height=small_plot_height, width=small_plot_width,
                        tools="pan, wheel_zoom, box_zoom, reset,lasso_select,hover")

xsrehandler2 = figure(height=small_plot_height, width=small_plot_width,
                      tools="pan, wheel_zoom, box_zoom, reset,lasso_select,hover")
# xsrehandler2 = display_xspec_cart_holo(ds,bu = 3,li = 0,sam = 5,typee='Re')
xsimhandler2 = figure(height=small_plot_height, width=small_plot_width,
                      tools="pan, wheel_zoom, box_zoom, reset,lasso_select,hover")
# xsimhandler2 = display_xspec_cart_holo(ds,bu = 3,li = 0,sam = 5,typee='Im')
rough_handler2 = figure(height=small_plot_height, width=small_plot_width,
                        tools="pan, wheel_zoom, box_zoom, reset,lasso_select,hover")
